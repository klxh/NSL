...
int main (int argc, char *argv[]){
    ...
    // Psi 100 with uniform transition rate
    ...
    double w = 2.5 * a0; // maximum width of a transition x1 -> x2
    ...
    FILE *fp1, *fp2, *fp3;
    fp1 = fopen("./data/uniform100.dat", "a");
    if (fp1 == NULL) {
        printf("Can't open uniform100.dat\n");
        exit(EXIT_FAILURE);
    }

    fp2 = fopen("./data/uniform100.xyz", "w");
    if (fp2 == NULL) {
        printf("Can't open uniform100.xyz\n");
        exit(EXIT_FAILURE);
    }
