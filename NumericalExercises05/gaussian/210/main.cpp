...
int main (int argc, char *argv[]){
    ...
    // Psi 210 with gaussian transition rate
    ...
    double w = 1.38 * a0; // maximum width of a transition x1 -> x2
    ...
    FILE *fp1, *fp2, *fp3;
    fp1 = fopen("./data/gaussian210.dat", "a");
    if (fp1 == NULL) {
        printf("Can't open gaussian210.dat\n");
        exit(EXIT_FAILURE);
    }

    fp2 = fopen("./data/gaussian210.xyz", "w");
    if (fp2 == NULL) {
        printf("Can't open gaussian210.xyz\n");
        exit(EXIT_FAILURE);
    }
